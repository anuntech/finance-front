	...
	return (
		<li key={i}>
			<figure className="relative flex h-full max-w-lg flex-col rounded-2xl bg-base-200 p-6 max-md:text-sm md:p-10">
				...
				<figcaption className="relative mt-4 flex items-center justify-start gap-4 border-base-content/5 border-t pt-4 md:mt-8 md:gap-8 md:pt-8">
					<div className="flex w-full items-center justify-between gap-2">
						...
						<div className="shrink-0 overflow-hidden rounded-full bg-base-300">
							{testimonial.img ? (
								...
								<span className="flex h-10 w-10 items-center justify-center rounded-full bg-base-300 font-medium text-lg md:h-12 md:w-12">
		...
		<section id="testimonials">
			<div className="mx-auto max-w-7xl px-8 py-24">
				...
				<ul
					...
					role=// biome-ignore lint/a11y/noRedundantRoles: <explanation>
					"list"
