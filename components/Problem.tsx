const Arrow = ({ extraStyle }: { extraStyle: string }) => {
	return (
		...
		<svg
			...
			className={`w-1w-12 2 shrinkll-neutral-content opacity-70 ${extraStyle}`}
			viewBox="0 0 138 138"
			fill="none"
	...
	return (
		<section className="bg-neutral text-neutral-content">
			<div className="mx-auto max-w-7xl px-8 py-16 text-center md:py-32">
				<h2 className="mx-auto mb-6 max-w-3xl font-extrabold text-4xl tracking-tight md:mb-8 md:text-5xl">
