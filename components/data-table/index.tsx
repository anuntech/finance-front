...
export const DataTable = <TData, TValue>({
	...
	// states
	const [filterIds, setFilterIds] = useState<Array<string>>([]);
	...
	return (
		<div
			className={
				"flex h-full min-h-[calc(100vh-5rem)] w-full flex-col justify-between gap-2"
			}
		>
			<div className="flex flex-col gap-2">
							...
							>
								...
								<EditDialog
									...
									dialogProps={{
										dialogContent: {
											className:
												"max-w-[100dvh] overflow-y-auto max-w-screen-md",
										},
									}}
									details={{
				...
				{filterIds.length > 0 && !isLoadingColumns && (
					<FilterRow
						filterIds={filterIds}
						setFilterIds={setFilterIds}
						columns={table.getAllColumns()}
						...
						setIsFilterRowOpen={setIsFilterRowOpen}
					/>
				)}
					...
					<div className="rounded-md border">
						<Table
							containerClassName={cn(
								...
								filterIds.length > 0 &&
									"min-h-[calc(100vh-9.5rem)] h-full max-h-[calc(100vh-9.5rem)]",
