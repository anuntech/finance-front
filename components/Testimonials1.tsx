...
const Testimonial = () => {
	return (
		...
		>
			...
			<div className="-z-10 absolute inset-y-0 right-1/2 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-base-100 shadow-lg ring-1 ring-base-content/10 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
			<div className="mx-auto max-w-2xl lg:max-w-5xl">
				<figure className="mt-10">
					<div className="flex flex-col items-center gap-12 lg:flex-row">
						<div className="sm:-rotate-1 relative rounded-xl border border-base-content/5 bg-base-content/5 p-1.5">
							<Image
								width={320}
								height={320}
								className="max-w-[320px] rounded-lg border-2 border-white/10 object-center shadow-md md:max-w-[280px] lg:max-w-[320px]"
						...
						<div>
							<blockquote className="font-medium text-base-content text-xl leading-8 sm:text-2xl sm:leading-10">
