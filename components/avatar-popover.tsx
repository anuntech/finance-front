		...
		<Popover modal={true} open={open} onOpenChange={handleSetOpen}>
			<PopoverTrigger asChild>
				<Button
					...
					className={`h-${height} w-${width} rounded-[50%] bg-white text-black shadow-lg transition-all duration-300 hover:bg-gray-100 focus:bg-gray-100`}
					title="Editar avatar"
				...
				>
					<Pencil
						// biome-ignore lint/nursery/useSortedClasses: <explanation>
						className={`h-${height / 2} w-${width / 2}`}
					/>
				</Button>
			</PopoverTrigger>
