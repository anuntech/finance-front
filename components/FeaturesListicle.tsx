		...
		<section className="py-24" id="features">
			<div className="mx-auto max-w-3xl">
				<div className="max-w-3xl bg-base-100 max-md:px-8">
					...
					<h2 className="mb-8 font-extrabold text-3xl tracking-tight lg:text-5xl">
						{/* 💡 COPY TIP: Remind visitors about the value of your product. Why do they need it? */}
						Supercharge your app instantly, launch faster, make $
					</h2>
					<div className="mb-8 text-base-content/80 leading-relaxed lg:text-lg">
			...
			<div>
				...
				<div className="bg-base-200">
					<div className="mx-auto flex max-w-3xl flex-col justify-center gap-12 md:flex-row md:items-center md:justify-start">
						<div
							className="max-w-xl animate-opacity space-y-4 px-12 py-12 text-base-content/80 leading-relaxed md:px-0"
							key={featureSelected}
						>
