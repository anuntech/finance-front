	...
	return (
		<>
			...
			<div>
				<Link
					href="/blog"
					className="link !no-underline inline-flex items-center gap-1 text-base-content/80 hover:text-base-content"
					title="Back to Blog"
				>
			...
			<article>
				...
				<section className="my-12 max-w-[800px] md:my-20">
					...
					<h1 className="mb-6 font-extrabold text-4xl tracking-tight md:mb-8 md:text-5xl lg:text-6xl">
						{article.title}
					</h1>
				...
				<div className="flex flex-col md:flex-row">
					...
					<section className="shrink-0 border-base-content/10 max-md:border-b max-md:pb-4 md:order-last md:w-72 md:border-l md:pl-12">
						<p className="mb-2 text-base-content/80 text-sm md:mb-3">
							Posted by
						</p>
								...
								<div className="space-y-2 md:space-y-5">
									{articlesRelated.map(article => (
										<div className="" key={article.slug}>
											...
											<p className="max-w-full text-base-content/80 text-sm">
												{article.description}
											</p>
										</div>
									))}
