			...
			cell: ({ row }) => {
				...
				const deleteCategoryMutation = useMutation({
					mutationFn: (id: string) =>
						deleteCategory(transactionNameApi, { id }),
					onSuccess: (id: string) => {
				...
				const deleteSubCategoryMutation = useMutation({
					mutationFn: (id: string) =>
						deleteSubCategory(transactionNameApi, { id, categoryId }),
					onSuccess: (id: string) => {
						queryClient.setQueryData(
							[`get-${transaction}`],
							(categories: Category) => {
								const newCategories = categories?.subCategories?.filter(
